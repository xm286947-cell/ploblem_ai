...
- 开始工作先完整阅读 `docs/requirements/CURRENT_PHASE_DEMO_BASELINE.md`；它是当前唯一执行口径。`REQ-020_CUSTOMER_QUALITY_SCENARIO_PORTRAIT_BASELINE_V1.md` 与 `SOL_DEVELOPMENT_HANDOFF.md` 仅作长期背景，不得挤入当前 Demo。新的明确用户要求优先。
