...
def main() -> int:
    ...
    manifest = {
        ...
        "included_capabilities": [
            ...
            "hardware-tree-import/v1 contract and versioned tree governance",
            "P07 backend API: Excel upload / mapping / preview-diff / atomic apply / history",
            "Company-only Real Validation Harness",
            "Offline synthetic package smoke",
        ],
        "release_blockers": [
            "HIFI_PRODUCT_GATE_PASS",
            "HC_TREE_IMPORT_P07_FRONTEND_GATE_PASS",
