...
D01_REQUIRED_SECTIONS = (
    {"entry_type": "ISSUE_FACT", "labels": ["问题经过"]},
    {"entry_type": "ROOT_CAUSE", "labels": ["根因分析"]},
    {"entry_type": "ACTION", "labels": ["整改措施"]},
    {"entry_type": "VERIFICATION", "labels": ["验证结果"]},
)
D01_SKILL_CODE = "major_d01_extract"
        ...
        return [
            MajorIssueObjectSpec(
                ...
                metadata={
                    ...
                    "skill_code": D01_SKILL_CODE,
                },
            )
            for spec in D01_REQUIRED_SECTIONS
        ]
        ...
        return SourceBundle(
            ...
            shared_context={
                ...
                "required_entry_types": [
                    item["entry_type"]
                    for item in D01_REQUIRED_SECTIONS
                ],
                "business_merge": {
                    "key": "entry_type",
